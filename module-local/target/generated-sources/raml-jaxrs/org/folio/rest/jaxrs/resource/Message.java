...
public interface Message {
  ...
  @Validate
  void getMessage(Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext);

  class GetMessageResponse extends ResponseDelegate {
    private GetMessageResponse(Response response, Object entity) {
      super(response, entity);
    }

    private GetMessageResponse(Response response) {
      super(response);
    }

    public static GetMessageResponse respond200WithApplicationVndApiJson(org.folio.rest.jaxrs.model.Message entity) {
      Response.ResponseBuilder responseBuilder = Response.status(200).header("Content-Type", "application/vnd.api+json");
      responseBuilder.entity(entity);
      return new GetMessageResponse(responseBuilder.build(), entity);
    }

    public static GetMessageResponse respond400WithApplicationJson(String entity) {
